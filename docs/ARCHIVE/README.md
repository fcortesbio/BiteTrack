...
- **DOCUMENTATION-UPDATE-SUMMARY.md** - Documentation audit results from November 4, 2025
...
- **REQUEST_RECOVERY_ENDPOINT.md** - Password recovery endpoint implementation
- **REQUEST_RECOVERY_TESTS.md** - Password recovery testing strategy
- **CSV_IMPORT_SECURITY_ANALYSIS.md** - Security analysis for CSV import feature
- **CSV_SALES_IMPORT_SPECIFICATION.md** - Sales CSV import feature specification
- **EMAIL_SERVICE_CONFIGURATION.md** - Email service setup and configuration
- **LINTING.md** - ESLint configuration and standards
- **PRODUCT_INTEGRATION_TESTS.md** - Product endpoint integration testing
- **test-customer-validation.md** - Customer validation logic documentation
...
- **[ROADMAP.md](../../ROADMAP.md)** - Strategic development roadmap and priorities
- **[docs/API-documentation.md](../API-documentation.md)** - Complete API reference
...
- Active development planning (use ROADMAP.md)
