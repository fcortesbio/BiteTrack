    ...
    for (const sale of sales) {
      ...
      for (const product of sale.products) {
        csvStream.write({
          ...
          'Customer Name': sale.customerId ? `${sale.customerId.firstName} ${sale.customerId.lastName}` : 'Unknown Customer',
          'Customer Email': sale.customerId ? sale.customerId.email : 'N/A',
          'Seller Name': sale.sellerId ? `${sale.sellerId.firstName} ${sale.sellerId.lastName}` : 'Unknown Seller',
          'Product Name': product.productId ? product.productId.productName : 'Unknown Product',
