    ...
    for (const sale of sales) {
      ...
      for (const product of sale.products) {
        csvStream.write({
          ...
          'Customer Name': `${sale.customerId.firstName} ${sale.customerId.lastName}`,
          'Customer Email': sale.customerId.email,
          'Seller Name': `${sale.sellerId.firstName} ${sale.sellerId.lastName}`,
          'Product Name': product.productId.productName,
